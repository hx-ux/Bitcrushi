...
def main():
  ...
  plistpath = scriptpath + "/resources/BitCrushi-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitCrushi-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitCrushi-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitCrushi-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BitCrushi-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BitCrushi.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BitCrushi.iss",inplace=1):
