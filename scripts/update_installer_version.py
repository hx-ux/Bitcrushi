...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BitCrushi Demo Installer\n"
      else:
        line="OutputBaseFilename=BitCrushi Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BitCrushi Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BitCrushi installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BitCrushi Demo installer\n"
     else:
       line="SetupWindowTitle=BitCrushi installer\n"
